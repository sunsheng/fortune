...
function getNewsList(){
	...
	for(var i=0;i<size;i++){
		...
		if(i==0){
			...
			newsStr+='<img class="newimg" src='+managePath+'/webNewsWebCtr/showNewsFile?filePath='+datas[i].cover+'&newsTitle='+datas[i].title+'&fileType=cover"/>';
